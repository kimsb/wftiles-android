...
public class Constants {
    ...
    static String ID_LOGIN_ACTIVITY = "ID_LOGIN_ACTIVITY";
    static String ID_GAME_LIST_ACTIVITY = "ID_GAME_LIST_ACTIVITY";
    static String ID_GAME_DETAIL_ACTIVITY = "ID_GAME_DETAIL_ACTIVITY";
